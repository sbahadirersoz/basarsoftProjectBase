...
{
    private readonly List<TaskPoint> pointList = new();
    [HttpPost("create")]
    public Task<TaskPoint> Create(TaskPoint task)
    {
        pointList.Add(task);
    ...
    [HttpGet("{id:guid}")]
    public async Task<TaskPoint> GetById(long  id)
    {
    ...
    [HttpGet("all")]
    public async Task<List<TaskPoint>> GetAll()
    {
        return pointList;
    }
